...
MARIADB_DEVEL=MariaDB-10.0.21-centos6-x86_64-devel
MARIADB_DEVEL_DOWNLOAD_PATH=http://mirrors.aliyun.com/mariadb/mariadb-10.0.21/yum/centos6-amd64/rpms/$MARIADB_DEVEL.rpm
